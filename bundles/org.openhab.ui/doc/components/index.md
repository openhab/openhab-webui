...
| [`oh-sipclient`](./oh-sipclient.html) |  [SIP Client](./oh-sipclient.html) | Use SIP over WebSocket to perform calls |
...
| [`oh-sipclient-card`](./oh-sipclient-card.html) |  [SIP Client Card](./oh-sipclient-card.html) | SIP Client |
