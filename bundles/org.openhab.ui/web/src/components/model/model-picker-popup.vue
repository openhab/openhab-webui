<template>
  <f7-popup ref="modelPicker" class="modelpicker-popup" close-on-escape @popup:open="onOpen" @popup:close="onClose">
    <f7-page>
      <f7-navbar>
        <f7-nav-left>
      ...
      <f7-toolbar v-else bottom class="toolbar-details" style="height: calc(50px + var(--f7-safe-area-bottom))">
        <f7-link v-if="!multiple" :disabled="selectedItem != null ? true : null" class="left" @click="selectedItem = null"> Clear </f7-link>
        <span v-else />
