...
export function useWidgetContext(context: WidgetContext) {
  ...
  const visible = computed(() => {
    ...
    const visibleTo = context.component.config.visibleTo
  ...
  // methods
  function evaluateExpression(key: string, value: any, _context?: WidgetContext, _props?: Record<string, any>): any {
  ...
  function cardChildContext(component: UiComponent): WidgetContext {
  ...
  // lifecycle
  onMounted(() => {
    const stylesheet = context?.component?.config?.stylesheet
    if (stylesheet) {
