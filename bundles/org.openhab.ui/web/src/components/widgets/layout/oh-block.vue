      ...
      <f7-menu v-if="context.editmode" class="configure-layout-menu padding-bottom">
        ...
        <f7-menu-item style="margin-left: auto" icon-f7="rectangle_grid_1x2" dropdown>
          <f7-menu-dropdown right>
            ...
            <f7-menu-dropdown-item v-if="context.clipboardtype === 'oh-grid-row' || context.clipboardtype === 'oh-grid-cells'" @click="context.editmode.pasteWidget(context.component, context.parent)" href="#" text="Paste"></f7-menu-dropdown-item>
            <f7-menu-dropdown-item v-if="context.clipboardtype === 'oh-grid-row' || context.clipboardtype === 'oh-grid-cells'" divider></f7-menu-dropdown-item>
