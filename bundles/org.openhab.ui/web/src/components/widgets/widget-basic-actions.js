...
export const basicActionsMixin = {
  ...
  methods: {
    ...
    /**
     * Performs a basic action determined by config parameters.
     * Basic actions are all actions that require no dependencies or dependencies without additional dependencies,
     * i.e. basic actions have no complex dependency chain. Usage of them is required when running into circular dependencies.
     *
     ...
     */
    performBasicAction (evt, prefix, config, context) {
