<template>
  <f7-segmented v-bind="config" round outline strong class="media-browser-controls" title="">
...
import { OhMediaBrowserDefinition } from '@/assets/definitions/widgets/system'

export default {
  mixins: [mixin],
  widget: OhMediaBrowserDefinition,
  mounted () {
