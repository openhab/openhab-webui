    ...
    <f7-row>
      <f7-col>
        <div class="row app-links">
          <div class="app-link col-100 medium-50" v-for="app in apps" :key="app.url" :href="app.url" external target="_blank">
            <f7-link class="app-link" :href="app.url" external target="_blank">
              <f7-card class="app-card">
                <f7-card-content :padding="false" :style="{
                  'height': '200px',
                  'background-image': 'url(' + app.imageUrl + ')',
