...
export const getSitemapEvents = <ThrowOnError extends boolean = false>(parameters: {
    subscriptionid: string;
    sitemap?: string;
}, options?: Options<never, ThrowOnError>): RequestResult<GetSitemapEventsResponses, GetSitemapEventsErrors, ThrowOnError, 'data'> => {
...
export const getSitemapEvents1 = <ThrowOnError extends boolean = false>(parameters: {
    ...
    sitemap?: string;
    pageid?: string;
}, options?: Options<never, ThrowOnError>): RequestResult<GetSitemapEvents1Responses, GetSitemapEvents1Errors, ThrowOnError, 'data'> => {
    const params = buildClientParams([parameters], [{ args: [
