...
export type ConfigDescriptionParameterDto = {
    context?: string;
    defaultValue?: string;
    description?: string;
    label?: string;
...
export type Rule = {
    ...
    visibility?: 'VISIBLE' | 'HIDDEN' | 'EXPERT';
    uid?: string;
    templateState?: 'no-template' | 'pending' | 'template-missing' | 'instantiated';
    configuration?: Configuration;
...
export type ThingActionDto = {
    actionUid?: string;
    label?: string;
    description?: string;
    visibility?: 'VISIBLE' | 'HIDDEN' | 'EXPERT';
    inputs?: Array<Input>;
    inputConfigDescriptions?: Array<ConfigDescriptionParameterDto>;
...
export type AudioSourceDto = {
    id?: string;
    label?: string;
};

export type UserApiTokenDto = {
    name?: string;
    createdTime?: string;
    scope?: string;
};
...
export type ConfigDescriptionParameterGroupDto = {
    name?: string;
    context?: string;
    advanced?: boolean;
    label?: string;
...
export type ConfigDescriptionDto = {
    uri?: string;
    parameters?: Array<ConfigDescriptionParameterDto>;
    parameterGroups?: Array<ConfigDescriptionParameterGroupDto>;
};

export type DiscoveryInfoDto = {
...
export type FileFormatChannelLinkDto = {
    channelUID?: string;
    configuration?: {
        [key: string]: {
            [key: string]: unknown;
...
export type FileFormatDto = {
    items?: Array<FileFormatItemDto>;
    things?: Array<ThingDto>;
};

export type FileFormatItemDto = {
    type?: string;
    name?: string;
    label?: string;
    category?: string;
    ...
    format?: string;
    metadata?: {
        [key: string]: MetadataDto;
    };
    channelLinks?: Array<FileFormatChannelLinkDto>;
};

export type GroupFunctionDto = {
    name?: string;
    params?: Array<string>;
};
...
export type ExtendedFileFormatDto = {
    items?: Array<FileFormatItemDto>;
    things?: Array<ThingDto>;
...
export type EnrichedItemChannelLinkDto = {
    itemName?: string;
    channelUID?: string;
    configuration?: {
        [key: string]: {
...
export type ItemChannelLinkDto = {
    itemName?: string;
    channelUID?: string;
    configuration?: {
        [key: string]: {
...
export type PersistenceCronStrategyDto = {
    name?: string;
    cronExpression?: string;
};

export type PersistenceFilterDto = {
    name?: string;
    value?: number;
    relative?: boolean;
    unit?: string;
...
export type PersistenceItemConfigurationDto = {
    items?: Array<string>;
    strategies?: Array<string>;
    filters?: Array<string>;
};

export type PersistenceServiceConfigurationDto = {
    serviceId?: string;
    configs?: Array<PersistenceItemConfigurationDto>;
    aliases?: {
        [key: string]: string;
    };
    defaults?: Array<string>;
    cronStrategies?: Array<PersistenceCronStrategyDto>;
    thresholdFilters?: Array<PersistenceFilterDto>;
    timeFilters?: Array<PersistenceFilterDto>;
    equalsFilters?: Array<PersistenceFilterDto>;
    includeFilters?: Array<PersistenceFilterDto>;
    editable?: boolean;
};
...
export type PersistenceServiceDto = {
    id?: string;
    label?: string;
    type?: string;
};
...
export type ConfigurableServiceDto = {
    id?: string;
    label?: string;
    category?: string;
    configDescriptionURI?: string;
...
export type EnrichedChannelDto = {
    uid?: string;
    id?: string;
    channelTypeUID?: string;
    itemType?: string;
...
export type EnrichedThingDto = {
    ...
    location?: string;
    semanticEquipmentTag?: string;
    channels?: Array<EnrichedChannelDto>;
    statusInfo?: ThingStatusInfo;
    firmwareStatus?: FirmwareStatusDto;
    editable?: boolean;
};

export type FirmwareStatusDto = {
    status?: string;
...
export type StrippedThingTypeDto = {
    UID?: string;
    label?: string;
    description?: string;
    category?: string;
...
export type ChannelDefinitionDto = {
    description?: string;
    id?: string;
    label?: string;
    tags?: Array<string>;
...
export type ChannelGroupDefinitionDto = {
    id?: string;
    description?: string;
    label?: string;
...
export type HumanLanguageInterpreterDto = {
    id?: string;
    label?: string;
...
export type GetConfigDescriptionsResponses = {
     ...
     * OK
     */
    200: Array<ConfigDescriptionDto>;
};
...
export type GetItemLinksResponses = {
     ...
     * OK
     */
    200: Array<EnrichedItemChannelLinkDto>;
};
...
export type GetItemLinkResponses = {
     ...
     * OK
     */
    200: EnrichedItemChannelLinkDto;
};
...
export type GetPersistenceServiceConfigurationResponses = {
     ...
     * OK
     */
    200: PersistenceServiceConfigurationDto;
};
...
export type PutPersistenceServiceConfigurationData = {
     ...
     */
    body: PersistenceServiceConfigurationDto;
    path: {
        /**
         * Id of the persistence service.
         */
...
export type GetPersistenceServicesResponses = {
     ...
     * OK
     */
    200: Array<PersistenceServiceDto>;
};
...
export type GetServicesResponses = {
     ...
     * OK
     */
    200: Array<ConfigurableServiceDto>;
};
...
export type GetThingTypesResponses = {
     ...
     * OK
     */
    200: Array<StrippedThingTypeDto>;
};
...
export type GetVoiceInterpreterByUidResponses = {
     ...
     * OK
     */
    200: Array<HumanLanguageInterpreterDto>;
};
