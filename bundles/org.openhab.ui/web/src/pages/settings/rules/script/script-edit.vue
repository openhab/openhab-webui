<template>
  <f7-page @page:afterin="onPageAfterIn" @page:beforeout="onPageBeforeOut">
    ...
    <blockly-editor ref="blocklyEditor" v-else-if="ready && !newScript && isBlockly" :blocks="currentModule.configuration.blockSource" @change="dirty = true" />
    <script-general-settings v-else-if="createMode" :createMode="true" :isScriptRule="true" :rule="rule" />
