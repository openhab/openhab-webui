<template>
  <f7-page @page:afterin="onPageAfterIn" @page:beforeout="onPageBeforeOut">
    ...
    <blockly-editor ref="blocklyEditor" v-else-if="ready && !newScript && isBlockly" :blocks="currentModule.configuration.blockSource" :isGraalJs="isMimeTypeAvailable(GRAALJS_MIME_TYPE)" @change="dirty = true" />
