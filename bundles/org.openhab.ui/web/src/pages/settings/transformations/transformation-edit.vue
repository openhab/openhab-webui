<template>
  <f7-page @page:afterin="onPageAfterIn" @page:beforeout="onPageBeforeOut">
    <f7-navbar :title="newTransformation ? 'Create Transformation' : 'Edit Transformation'" :subtitle="(!newTransformation && transformation) ? editorMode : ''" back-link="Back">
    ...
    <editor v-if="!newTransformation && ready && (!isBlockly || blocklyCodePreview)" class="rule-script-editor" :mode="editorMode" :value="transformation.configuration.function" @input="onEditorInput" :read-only="isBlockly || !isEditable" :tern-autocompletion-hook="true" />
