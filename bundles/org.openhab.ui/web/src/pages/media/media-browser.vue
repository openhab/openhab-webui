<template>
  <f7-page class="media-content">
    ...
    <div v-if="node">
      ...
      <div v-else>
        <div v-for="r1 in node.childs" style="width:200px;height:200px;position:relative;float:left;margin:20px;background-color:#ffffff;color:#000000;border:solid 1px;border-radius:10px;padding:10px;" v-bind:key="node.path">
