      ...
      <f7-page>
        ...
        <f7-tabs>
                    ...
                    <table>
                      ...
                      <tbody>
                        <tr v-for="(options, idx) in seriesOptions" :key="idx">
                          ...
                          <td class="label-cell">
                            <f7-segmented
                              v-if="'showAxesOptions' in options && options.showAxesOptions"
                              round>
                              <f7-button
                          ...
                          <td class="label-cell">
                            <f7-link
                              v-if="'aggregation' in options"
                              @click="chooseAggregation(options as AggregateSeriesOptions)">
          ...
          <f7-tab id="tab-ranges" class="no-margin no-padding">
            ...
            <f7-row
              v-else-if="'valueAxesOptions' in coordSettings && coordSettings.valueAxesOptions?.length > 0">
              <f7-col :width="100">
                <div class="card data-table">
