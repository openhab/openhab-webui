<template>
  <f7-page name="devtools" @page:beforeremove="onPageBeforeRemove">
    ...
    <f7-tabs>
      <f7-tab id="tab-menu" tab:show="() => this.currentTab = 'menu'" :tab-active="currentTab === 'menu'">
      ...
      <f7-tab id="tab-debug" @tab:show="() => (this.currentTab = 'debug')" :tab-active="currentTab === 'debug'">
        <!-- Test SSE connection -->
