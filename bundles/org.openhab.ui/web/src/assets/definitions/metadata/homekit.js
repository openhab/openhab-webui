...
export const homekitParameters = {
  ...
  'Faucet': [instanceParameter],
  'Filter': [instanceParameter],
  'GarageDoorOpener': [instanceParameter],
  ...
  'Lock': [instanceParameter],
  'Microphone': [instanceParameter],
  ...
  'Slat': [instanceParameter],
  'SmartSpeaker': [instanceParameter],
  ...
  'Speaker': [instanceParameter],
  'StatelessProgrammableSwitch': [instanceParameter],
  'Television': [instanceParameter],
  'TemperatureSensor': [instanceParameter],
