...
const activeEnum = [m('INACTIVE', 'TEXT', 'INACTIVE', 'Value for OFF'), m('ACTIVE', 'TEXT', 'ACTIVE', 'Value for ON')]
...
const targetDoorStateEnum = [m('OPEN', 'TEXT', 'OPEN', 'Value to open the door'), m('CLOSED', 'TEXT', 'CLOSED', 'Value to close the door')]
