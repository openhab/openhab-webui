...
export default function (f7) {
  ...
  Blockly.Blocks['oh_text_replace'] = {
    init: function () {
      ...
      this.appendValueInput('replacement').appendField('with').setAlign(Blockly.inputs.Align.RIGHT).setCheck('String')
      this.appendValueInput('origin').appendField('in').setAlign(Blockly.inputs.Align.RIGHT).setCheck('String')
