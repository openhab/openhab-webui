...
export default function (f7) {
  ...
  Blockly.Blocks['oh_groupmembers'] = {
    init: function () {
      this.appendValueInput('groupName').appendField('get members of group').setCheck(['String', 'oh_item'])
  ...
  Blockly.Blocks['oh_taggeditems'] = {
    init: function () {
      this.appendValueInput('tagName').appendField('get items with tag').setCheck(['String', 'Array'])
      this.setInputsInline(false)
      this.setOutput(true, 'Array')
      this.setColour(0)
  ...
  Blockly.Blocks['oh_getitem_state'] = {
    init: function () {
      this.appendValueInput('itemName').appendField('get state of item').setCheck(['String', 'oh_item'])
      this.setInputsInline(false)
