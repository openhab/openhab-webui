...
export const OhMapPageDefinition = () => new WidgetDefinition('oh-map-page', 'Map page', 'Displays markers on a map')
  .params([
    ...
    pt('tileLayerProvider', 'Provider for the tile layer', 'The provider of tiles to use for the background of the map. ' +
      ...
      'example: <em>Stamen.Watercolor</em>. Some providers will not work until you set options, like access tokens, in the <code>tileLayerProviderOptions</code> parameter (in Code view). ' +
