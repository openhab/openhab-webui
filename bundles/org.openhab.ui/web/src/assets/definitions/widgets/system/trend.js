...
export default () => [
  ...
  pt('trendGradient', 'Trend Line Gradient', 'Colors of the trend line (see <a target="_blank" class="external text-color-alt" href="https://github.com/QingWei-Li/vue-trend#props">vue-trend</a>)').a(),
