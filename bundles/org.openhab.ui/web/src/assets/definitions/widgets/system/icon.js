...
export default () => [
  ...
  pt('color', 'Color', 'Color of the icon (for F7/Material icons, a <a class="external text-color-theme-alt" target="_blank" href="https://v5.framework7.io/docs/color-themes.html#colors">Framework7 color theme</a>, for Iconify icons, a CSS color). Not applicable to OH icons.'),
