...
export default () => [
  ...
  inputTypeParam,
  pt('inputmode', 'Input Mode', 'Type of data that might be entered (see <a class="external text-color-alt" target="_blank" href="https://developer.mozilla.org/en-US/docs/Web/HTML/Global_attributes/inputmode">MDN docs</a>)'),
