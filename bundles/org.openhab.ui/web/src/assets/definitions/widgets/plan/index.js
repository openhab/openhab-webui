...
export const OhPlanMarkerDefinition = () => new WidgetDefinition('oh-plan-marker', 'Floor Plan Marker', 'A marker on a floor plan', 'map_pin')
  .paramGroup(pg('marker', 'Marker Settings'), [
    ...
    pt('visible', 'Visibility', 'Enter an expression to dynamically show the marker, see <a class="external text-color-alt" target="_blank" href="https://www.openhab.org/docs/ui/building-pages.html#widgets-definition-usage">Building Pages: <code>visible</code></a>')
  ])
