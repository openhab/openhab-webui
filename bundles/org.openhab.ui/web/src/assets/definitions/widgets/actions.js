...
export const actionParams = (groupName, paramPrefix) => {
  ...
  return [
    ...
    po(paramPrefix + 'actionPageTransition', 'Transition Effect', 'Use a specific <a class="external text-color-theme-alt" target="_blank" href="https://framework7.io/docs/view.html#custom-page-transitions">page transition animation</a>', [
    ...
    pt(paramPrefix + 'actionFeedback', 'Action Feedback', 'Shows a toast popup when the action has been executed. Can either be a text to show or a JSON object including some of the <a class="external text-color-theme-alt" target="_blank" href="https://framework7.io/docs/toast.html#toast-parameters">supported parameters</a>').a()
      .v((value, configuration, configDescription, parameters) => {
