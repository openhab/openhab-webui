...
export const actionParams = (groupName, paramPrefix) => {
  ...
  return [
    ...
    pt(paramPrefix + 'actionConfirmation', 'Action Confirmation', 'Shows a confirm popup or sheet to ask for confirmation before the action is executed. Can either be a text to show or a JSON object <code>{ type: "sheet", text: "Confirm", color: "green" }</code> or <code>{ type: "dialog", title: "Confirm", text: "Are you sure?" }</code>').a(),
