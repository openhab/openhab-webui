...
let ParserRules = [
  ...
  {
    name: 'AggArgs',
    symbols: [{ literal: '(' }, lexer.has('identifier') ? { type: 'identifier' } : identifier, { literal: ')' }],
  ...
  {
    name: 'IconValue',
    symbols: [lexer.has('identifier') ? { type: 'identifier' } : identifier, lexer.has('colon') ? { type: 'colon' } : colon, 'IconName']
  },
  {
    name: 'IconValue',
    symbols: [
  ...
  {
    name: 'IconName',
    symbols: [lexer.has('identifier') ? { type: 'identifier' } : identifier, lexer.has('hyphen') ? { type: 'hyphen' } : hyphen, 'IconName'],
