...
let ParserRules = [
  ...
  {
    name: 'Item',
    symbols: ['Type', '_', 'Name', 'Label', 'Icon', 'Groups', 'Tags', 'Metadata'],
  ...
  {
    name: 'Type',
    symbols: [lexer.has('itemtype') ? { type: 'itemtype' } : itemtype],
    postprocess: d => [d[0].text.trim()]
  },
  {
    name: 'Type',
    symbols: [
    ...
    postprocess: d => ['Number:' + d[2].text]
  },
  {
    name: 'Type',
    symbols: [{ literal: 'Group' }, lexer.has('membertype') ? { type: 'membertype' } : membertype],
    postprocess: d => ['Group', d[1].text.substring(1)]
  },
  {
    name: 'Type',
    symbols: [
      { literal: 'Group' },
      lexer.has('membertype') ? { type: 'membertype' } : membertype,
      { literal: ':' },
      lexer.has('aggfunc') ? { type: 'aggfunc' } : aggfunc,
      'AggArgs'
    ],
    postprocess: d => ['Group', d[1].text.substring(1), { name: d[3].text, params: d[4] }]
  },
  {
    name: 'Type',
    symbols: [
    ...
    postprocess: d => ['Group', 'Number:' + d[3].text]
  },
  {
    name: 'Type',
    symbols: [
    ...
    postprocess: d => ['Group', 'Number:' + d[3].text, { name: d[5].text, params: d[6] }]
  },
  ...
  },
  {
    ...
    postprocess: d => [d[1].text, d[5].text]
  },
  {
    name: 'Name',
  ...
  {
    name: 'Label',
    symbols: ['__', lexer.has('string') ? { type: 'string' } : string],
    postprocess: d => d[1].value
  },
  { name: 'Icon', symbols: [], postprocess: d => undefined },
  {
    name: 'Icon',
    symbols: ['__', { literal: '<' }, '_', 'IconValue', '_', { literal: '>' }],
    postprocess: d => d[3].join('')
  },
  ...
  {
    name: 'Groups',
    symbols: ['__', { literal: '(' }, 'GroupList', { literal: ')' }],
    postprocess: d => d[2]
  },
  { name: 'GroupList', symbols: ['_', 'GroupName', '_'], postprocess: d => [d[1]] },
  {
    name: 'GroupList',
    symbols: ['GroupList', { literal: ',' }, '_', 'GroupName', '_'],
    postprocess: d => d[0].concat(d[3])
  },
  {
    name: 'GroupName',
    symbols: [lexer.has('identifier') ? { type: 'identifier' } : identifier],
  ...
  {
    name: 'Tags',
    symbols: ['__', { literal: '[' }, 'TagList', { literal: ']' }],
    postprocess: d => d[2]
  },
  { name: 'TagList', symbols: ['_', 'Tag', '_'], postprocess: d => [d[1]] },
  {
    name: 'TagList',
    symbols: ['TagList', { literal: ',' }, '_', 'Tag', '_'],
    postprocess: d => d[0].concat(d[3])
  },
  {
    name: 'Tag',
  ...
  {
    name: 'Metadata',
    symbols: ['__', { literal: '{' }, 'MetadataList', { literal: '}' }],
    postprocess: d => d[2]
  },
  { name: 'MetadataList', symbols: ['_', 'MetadataEntry', '_'], postprocess: d => [d[1]] },
  {
    name: 'MetadataList',
    symbols: ['MetadataList', { literal: ',' }, '_', 'MetadataEntry', '_'],
    postprocess: d => d[0].concat(d[3])
  },
  {
    name: 'MetadataEntry',
    symbols: ['MetadataKey', '_', { literal: '=' }, '_', 'MetadataValue'],
    postprocess: d => {
  ...
  {
    name: 'MetadataValue',
    symbols: [lexer.has('string') ? { type: 'string' } : string, '_', 'MetadataConfig'],
    postprocess: d => {
      return { value: d[0].value, config: d[2] }
    }
  },
  {
    name: 'MetadataConfig',
    symbols: [{ literal: '[' }, 'MetadataConfigList', { literal: ']' }],
    postprocess: d => d[1]
  },
  {
    name: 'MetadataConfigList',
    symbols: ['_', 'MetadataConfigItem', '_'],
    postprocess: d => [d[1]]
  },
  {
    name: 'MetadataConfigList',
    symbols: ['MetadataConfigList', { literal: ',' }, '_', 'MetadataConfigItem', '_'],
    postprocess: d => d[0].concat(d[3])
  },
  {
    name: 'MetadataConfigItem',
    symbols: ['MetadataConfigKey', '_', { literal: '=' }, '_', 'MetadataConfigValue'],
    postprocess: d => {
      return { key: d[0], value: d[4] }
    }
  },
  {
    name: 'MetadataConfigKey',
    symbols: [lexer.has('identifier') ? { type: 'identifier' } : identifier],
    postprocess: d => d[0].text
  },
  {
    name: 'MetadataConfigValue',
    symbols: [lexer.has('string') ? { type: 'string' } : string],
    postprocess: d => d[0].value
  },
  {
  ...
  {
    name: '_',
    symbols: ['_', lexer.has('comment') ? { type: 'comment' } : comment],
    postprocess: () => null
  },
  ...
  {
    name: '__',
    symbols: ['__', lexer.has('comment') ? { type: 'comment' } : comment],
    postprocess: () => null
  }
]
