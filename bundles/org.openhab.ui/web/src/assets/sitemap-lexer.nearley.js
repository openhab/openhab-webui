...
let ParserRules = [
  ...
  {
    name: 'SitemapLabel',
    symbols: [lexer.has('label') ? { type: 'label' } : label, '_', lexer.has('string') ? { type: 'string' } : string],
    postprocess: (d) => {
  ...
  {
    name: 'WidgetAttr',
    symbols: [lexer.has('widgetfrcitmattr') ? { type: 'widgetfrcitmattr' } : widgetfrcitmattr, '_', 'WidgetBooleanAttrValue'],
    postprocess: (d) => ['forceAsItem', d[2]]
  },
  {
    name: 'WidgetAttr',
    symbols: [lexer.has('widgetboolattr') ? { type: 'widgetboolattr' } : widgetboolattr, '_', 'WidgetBooleanAttrValue'],
    postprocess: (d) => [d[0].value, d[2]]
  },
  {
    name: 'WidgetAttr',
    symbols: [lexer.has('widgetperiodattr') ? { type: 'widgetperiodattr' } : widgetperiodattr, '_', 'WidgetPeriodAttrValue'],
    postprocess: (d) => ['period', d[2]]
  },
  {
    name: 'WidgetAttr',
    symbols: [lexer.has('widgetclickattr') ? { type: 'widgetclickattr' } : widgetclickattr, '_', 'WidgetAttrValue'],
    postprocess: (d) => ['cmd', d[2]]
  },
  {
    name: 'WidgetAttr',
    symbols: [lexer.has('widgetreleaseattr') ? { type: 'widgetreleaseattr' } : widgetreleaseattr, '_', 'WidgetAttrValue'],
  ...
  {
    name: 'WidgetAttr',
    symbols: [lexer.has('staticIcon') ? { type: 'staticIcon' } : staticIcon, '_', 'WidgetIconAttrValue'],
    postprocess: (d) => [d[0].value, joinValue(d[2])]
  },
  ...
  {
    name: 'WidgetPeriodAttrValue',
    symbols: [lexer.has('hyphen') ? { type: 'hyphen' } : hyphen, lexer.has('identifier') ? { type: 'identifier' } : identifier],
  ...
  {
    name: 'Visibilities',
    symbols: ['Visibilities', '_', lexer.has('comma') ? { type: 'comma' } : comma, '_', 'Conditions'],
    postprocess: (d) => d[0].concat(d[4])
  },
  ...
  {
    name: 'Color',
    symbols: ['Conditions', '_', lexer.has('equals') ? { type: 'equals' } : equals, '_', 'ColorName'],
  ...
  {
    name: 'IconRule',
    symbols: ['Conditions', '_', lexer.has('equals') ? { type: 'equals' } : equals, '_', 'WidgetIconAttrValue'],
  ...
  {
    name: 'Number',
    symbols: [lexer.has('hyphen') ? { type: 'hyphen' } : hyphen, lexer.has('unsignedint') ? { type: 'unsignedint' } : unsignedint],
