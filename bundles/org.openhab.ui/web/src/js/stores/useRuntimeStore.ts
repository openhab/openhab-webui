...
import { type RootBean, type Links } from '@/api'
...
export const useRuntimeStore = defineStore('runtime', () => {
  ...
  const measurementSystem = ref<string | null>(null)
  const apiEndpoints = ref<Links[] | null>(null)
  ...
  // Actions
  function setRootResource (rootResponse: RootBean) {
