...
import { getItems, type EnrichedItemDto } from '@/api'

interface ModelItem extends EnrichedItemDto {
  modelPath: ModelItem[]
...
export const useModelStore = defineStore('model', () => {
  ...
  async function loadSemanticModel () {
    getItems({ query: { staticDataOnly: true, metadata: 'semantics,listWidget,widgetOrder' }}).then((data) => {
      let modelItems = data.data as ModelItem[]
