...
const AboutPage = () =>
  import(/* webpackChunkName: "about-page" */ "../pages/about.vue");
const UserProfilePage = () =>
  import(/* webpackChunkName: "profile-page" */ "../pages/profile.vue");

const SettingsMenuPage = () =>
  import(
    /* webpackChunkName: "admin-base" */ "../pages/settings/menu/settings-menu.vue"
  );
const ServiceSettingsPage = () =>
  import(
    /* webpackChunkName: "admin-base" */ "../pages/settings/services/service-settings.vue"
  );
const AddonsConfigureBindingPage = () =>
  import(
    /* webpackChunkName: "admin-base" */ "@/pages/addons/addon-config.vue"
  );
const AddonsStorePage = () =>
  import(
    /* webpackChunkName: "admin-base" */ "@/pages/addons/addons-store.vue"
  );
const AddonDetailsPage = () =>
  import(
    /* webpackChunkName: "admin-base" */ "@/pages/addons/addon-details.vue"
  );

const ItemsListPage = () =>
  import(
    /* webpackChunkName: "admin-config" */ "../pages/settings/items/items-list-vlist.vue"
  );
const ItemDetailsPage = () =>
  import(
    /* webpackChunkName: "admin-config" */ "../pages/settings/items/item-details.vue"
  );
const ItemEditPage = () =>
  import(
    /* webpackChunkName: "admin-config" */ "../pages/settings/items/item-edit.vue"
  );
...
const HealthOverviewPage = () =>
  import(
    /* webpackChunkName: "admin-config" */ "../pages/settings/health/health-overview.vue"
  );
const HealthOrphanLinksPage = () =>
  import(
    /* webpackChunkName: "admin-config" */ "../pages/settings/health/health-orphanlinks.vue"
  );
const ThingsListPage = () =>
  import(
    /* webpackChunkName: "admin-config" */ "../pages/settings/things/things-list.vue"
  );
const ThingDetailsPage = () =>
  import(
    /* webpackChunkName: "admin-config" */ "../pages/settings/things/thing-details.vue"
  );
const AddThingChooseBindingPage = () =>
  import(
    /* webpackChunkName: "admin-config" */ "../pages/settings/things/add/choose-binding.vue"
  );
...
const AddThingPage = () =>
  import(
    /* webpackChunkName: "admin-config" */ "../pages/settings/things/add/thing-add.vue"
  );

const InboxListPage = () =>
  import(
    /* webpackChunkName: "admin-config" */ "../pages/settings/things/inbox/inbox-list.vue"
  );
...
const SemanticModelPage = () =>
  import(
    /* webpackChunkName: "admin-config" */ "../pages/settings/model/model.vue"
  );

const PagesListPage = () =>
  import(
    /* webpackChunkName: "admin-pages" */ "../pages/settings/pages/pages-list.vue"
  );
const PageEditors = {
  home: () =>
    import(
      /* webpackChunkName: "admin-pages" */ "../pages/settings/pages/home/home-edit.vue"
    ),
  layout: () =>
    import(
      /* webpackChunkName: "admin-pages" */ "../pages/settings/pages/layout/layout-edit.vue"
    ),
  tabs: () =>
    import(
      /* webpackChunkName: "admin-pages" */ "../pages/settings/pages/tabs/tabs-edit.vue"
    ),
  map: () =>
    import(
      /* webpackChunkName: "admin-pages-leaflet" */ "../pages/settings/pages/map/map-edit.vue"
    ),
  plan: () =>
    import(
  ...
  sitemap: () =>
    import(
      /* webpackChunkName: "admin-pages" */ "../pages/settings/pages/sitemap/sitemap-edit.vue"
    ),
};

const RulesListPage = () =>
  import(
    /* webpackChunkName: "admin-rules" */ "../pages/settings/rules/rules-list.vue"
  );
const RuleEditPage = () =>
  import(
    /* webpackChunkName: "admin-rules" */ "../pages/settings/rules/rule-edit.vue"
  );
const SceneEditPage = () =>
  import(
    /* webpackChunkName: "admin-rules" */ "../pages/settings/rules/scene/scene-edit.vue"
  );
const ScriptEditPage = () =>
  import(
    /* webpackChunkName: "admin-rules" */ "../pages/settings/rules/script/script-edit.vue"
  );
const SchedulePage = () =>
  import(
    /* webpackChunkName: "admin-schedule" */ "../pages/settings/schedule/schedule.vue"
  );

const DeveloperToolsPage = () =>
  import(
    /* webpackChunkName: "admin-devtools" */ "../pages/developer/developer-tools.vue"
  );
const WidgetsListPage = () =>
  import(
    /* webpackChunkName: "admin-devtools" */ "../pages/developer/widgets/widget-list.vue"
  );
const WidgetEditPage = () =>
  import(
    /* webpackChunkName: "admin-devtools" */ "../pages/developer/widgets/widget-edit.vue"
  );
const BlocksListPage = () =>
  import(
    /* webpackChunkName: "admin-devtools" */ "../pages/developer/blocks/blocks-list.vue"
  );
const BlocksEditPage = () =>
  import(
    /* webpackChunkName: "blockly-editor" */ "../pages/developer/blocks/blocks-edit.vue"
  );
const ApiExplorerPage = () =>
  import(
    /* webpackChunkName: "admin-devtools" */ "../pages/developer/api-explorer.vue"
  );
const LogViewerPage = () =>
  import(
    /* webpackChunkName: "admin-devtools" */ "../pages/developer/log-viewer.vue"
  );

const SetupWizardPage = () =>
  import(
    /* webpackChunkName: "setup-wizard" */ "../pages/wizards/setup-wizard.vue"
  );
        ...
        routes: [
          {
            ...
            async: loadAsync(TransformationsEditPage, (routeTo) =>
              routeTo.params.transformationId === "add"
                ? { createMode: true }
                : {}
            ),
          },
