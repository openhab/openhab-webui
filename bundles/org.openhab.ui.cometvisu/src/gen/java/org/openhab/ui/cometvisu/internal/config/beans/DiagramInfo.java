 ...
 *         &lt;element name="influx" type="{}influx" maxOccurs="unbounded" minOccurs="0"/&gt;
...
public class DiagramInfo {
     ...
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the influx property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getInflux().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<Influx> getInflux() {
        if (influx == null) {
            influx = new ArrayList<Influx>();
        }
        return this.influx;
    }
